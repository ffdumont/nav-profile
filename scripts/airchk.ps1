# Airspace Checker PowerShell Wrapper
# Windows-friendly interface for airspace checking services
...
function Show-Help {
    Write-Host @"
🛩️ Airspace Checker - Flight Profile & Airspace Analysis PowerShell Interface

Usage: .\airchk.ps1 COMMAND [OPTIONS]
...
EXAMPLES:
  .\airchk.ps1 list -Name "CHEVREUSE"
  .\airchk.ps1 generate -Id 4749 -Output "my_airspace.kml"
  .\airchk.ps1 generate -Name "PARIS" -Directory "kml_output"
  .\airchk.ps1 stats -Detailed
...
For detailed command help: .\airchk.ps1 help <command>
"@
}
...
if ($Command -notin $validCommands) {
    ...
    Write-Host "Use '.\airchk.ps1 -Help' for usage information."
    exit 1
}
...
try {
    ...
    Write-Error "Failed to execute Airspace Checker: $_"
    exit 1
}